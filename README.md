...
# 制作背景
  ...
  gif画像 トップページ     https://gyazo.com/48eb76dc842ab2cfec2be5ca2ae99deb
...
# 課題や今後実装したい機能
 ...
 ・家族表示機能とはユーザー登録してある家族の名前（もしくはニックネーム）をトップページで表示できるようにし、
  その家族の投稿した思い出を閲覧できるようにする事ができる機能を実装したいと考えております。
